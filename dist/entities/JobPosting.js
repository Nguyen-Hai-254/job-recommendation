...
__decorate([
    (0, typeorm_1.ManyToOne)(() => _1.Employer, (employer) => employer.jobPostings, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE'
    }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => _1.Application, (application) => application.jobPosting),
    __metadata("design:type", Array)
], JobPosting.prototype, "applications", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => _1.Employee, (employee) => employee.jobs),
    __metadata("design:type", Array)
