...
__decorate([
    (0, typeorm_1.Column)({
        ...
        default: enum_1.userRole.Employee
    }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.OneToOne)(() => Employer_1.Employer, (employer) => employer.user),
    __metadata("design:type", Employer_1.Employer)
], User.prototype, "employer", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => Employee_1.Employee, (employee) => employee.user),
