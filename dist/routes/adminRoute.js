...
route.get('/api/v1/admin/candidate-statistics-by-query', auth_1.verifyToken, (0, verifyRole_1.verifyRole)(enum_1.userRole.Admin), adminController_1.default.candidateStatisticsByQuery);
