...
route.get('/employee/follow-company', auth_1.verifyToken, (0, verifyRole_1.verifyRole)(enum_1.userRole.Employee), paginationParser_1.paginationParser, followController_1.default.getFollowByEmployee);
...
route.get('/employer/save-employee', auth_1.verifyToken, (0, verifyRole_1.verifyRole)(enum_1.userRole.Employer), paginationParser_1.paginationParser, followController_1.default.getSaveEmployeeByEmployer);
...
route.get('/employee/follow-job', auth_1.verifyToken, (0, verifyRole_1.verifyRole)(enum_1.userRole.Employee), paginationParser_1.paginationParser, followController_1.default.getFollowJobPosting);
